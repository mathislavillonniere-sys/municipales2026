  ...
  },
  {
    ...
    candidates: [
      ...
      },
      {
        ...
        color: "#adc1fd",
        score: "",
        slogan: "Grandir • Vivre • Transmettre",
      },
      {
        name: "Siham Labich",
        party: "MoDem diss.",
      ...
      },
      {
        ...
        color: "#1d06e7",
        score: "",
        slogan: "Relevons Saint-Étienne !",
      },
      {
        name: "Romain Brossard",
        party: "LO",
        color: "#bb0000",
        score: "",
        slogan: "Lutte ouvrière - Faire entendre le camp des travailleurs",
    ...
    results2026: {
      tour1: [
        ...
        { candidate: "Marc Chassaubéné", party: "DVD", score: "" },
        { candidate: "Siham Labich", party: "MoDem diss.", score: "" },
        { candidate: "Éric Le Jaouen", party: "HOR", score: "" },
        { candidate: "Romain Brossard", party: "LO", score: "" },
        { candidate: "Participation", score: "" },
        { candidate: "Vote blanc", party: "Non comptabilisé", score: "" },
        { candidate: "Vote Nul", party: "Non comptabilisé", score: "" },
      ],
  ...
  },
  {
    ...
    candidates: [
      ...
      },
      {
        ...
        color: "#e195d4",
        score: "",
        slogan: "Utiles pour Strasbourg",
      },
      {
        name: "Neïla Boutghata",
        party: "SE",
        color: "#cccccc",
        score: "",
        slogan: "Engagé.e.s pour Strasbourg",
      },
      {
        name: "Jean-Thierry Gangloff",
        party: "SE",
        color: "#cccccc",
        score: "",
        slogan: "Vision collective 67",
      },
      {
        name: "Fahad Raja Muhammad",
        party: "SE",
        color: "#cccccc",
        score: "",
        slogan: "Strasbourg sans frontières",
      },
      {
        name: "Louise Fève",
        party: "LO",
      ...
      {
        name: "Clément Soubise",
        party: "NPA -R",
        color: "#bb0000",
        score: "",
        slogan: "NPA Révolutionnaires - Strasbourg ouvrière et révolutionnaire",
      },
      {
        name: "Eva Lacote",
        party: "PT",
        color: "#bb0000",
        score: "",
        slogan: "Strasbourg pour les jeunes et les travailleurs",
      },
    ],
    polls: [
      {
    ...
    results2026: {
      tour1: [
        ...
        { candidate: "Mohamed Sylla", party: "Utiles - PRG", score: "" },
        { candidate: "Neïla Boutghata", party: "SE", score: "" },
        { candidate: "Jean-Thierry Gangloff", party: "SE", score: "" },
        { candidate: "Fahad Raja Muhammad", party: "SE", score: "" },
        { candidate: "Louise Fève", party: "LO", score: "" },
        { candidate: "Clément Soubise", party: "NPA -R", score: "" },
        { candidate: "Eva Lacote", party: "PT", score: "" },
        { candidate: "Participation", score: "" },
        { candidate: "Vote blanc", party: "Non comptabilisé", score: "" },
        { candidate: "Vote Nul", party: "Non comptabilisé", score: "" },
      ],
  ...
  // --- T ---
  {
    ...
    results2026: {
      tour1: [
        ...
        { candidate: "Michel Bonnus", party: "LR", score: "" },
        { candidate: "Magali Brunel", party: "PS - PCF - LÉ - PP	", score: "" },
        { candidate: "Isaline Cornil", party: "LFI", score: "" },
        { candidate: "Jean-Michel Ghiotto", party: "LO", score: "" },
        { candidate: "Participation", score: "" },
        { candidate: "Vote blanc", party: "Non comptabilisé", score: "" },
        { candidate: "Vote Nul", party: "Non comptabilisé", score: "" },
      ],
  ...
  },
  {
    ...
    candidates: [
      ...
      },
      {
        ...
        color: "#13151d",
        score: "",
        slogan: "À la Reconquête ! de Toulouse",
      },

      {
        name: "Lambert Meilhac",
        party: "EQX",
        color: "#77ff77",
        score: "",
        slogan: "Nouvel",
      ...
      {
        name: "Vanessa Pedinotti",
        party: "RP",
        color: "#bb0000",
        score: "",
        slogan: "Une travailleuse au Capitole",
      },
      {
    ...
    results2026: {
      tour1: [
        ...
        { candidate: "Arthur Cottrel", party: "REC", score: "" },
        { candidate: "Lambert Meilhac", party: "EQX", score: "" },
        { candidate: "Vanessa Pedinotti", party: "RP", score: "" },
        { candidate: "Guillaume Scali", party: "NPA", score: "" },
        { candidate: "Malena Adrada", party: "LO", score: "" },
        { candidate: "Julian Menendez", party: "PT", score: "" },
        { candidate: "Participation", score: "" },
        { candidate: "Vote blanc", party: "Non comptabilisé", score: "" },
        { candidate: "Vote Nul", party: "Non comptabilisé", score: "" },
      ],
  ...
  },
  {
    ...
    results2026: {
      tour1: [
        ...
        { candidate: "Christophe Charlon", party: "LO", score: "" },
        { candidate: "Participation", score: "" },
        { candidate: "Vote blanc", party: "Non comptabilisé", score: "" },
        { candidate: "Vote Nul", party: "Non comptabilisé", score: "" },
      ],
  ...
  },
  {
    ...
    candidates: [
      ...
      },
      {
        ...
        color: "#bb0000",
        score: "",
        slogan: "Tours pour les travailleurs et les jeunes",
      },
    ],
    polls: [
      {
    ...
    results2026: {
      tour1: [
        ...
        { candidate: "Thomas Jouhannaud", party: "LO", score: "" },
        { candidate: "Claire Delore", party: "PT", score: "" },
        { candidate: "Participation", score: "" },
        { candidate: "Vote blanc", party: "Non comptabilisé", score: "" },
        { candidate: "Vote Nul", party: "Non comptabilisé", score: "" },
      ],
  ...
  // --- V ---
  {
    ...
    results2026: {
      tour1: [
        ...
        { candidate: "Adèle Kopff", party: "LO", score: "" },
        { candidate: "Participation", score: "" },
        { candidate: "Vote blanc", party: "Non comptabilisé", score: "" },
        { candidate: "Vote Nul", party: "Non comptabilisé", score: "" },
      ],
  ...
  },
  {
    ...
    results2026: {
      tour1: [
        ...
        { candidate: "Nadia Bouhami", party: "LO", score: "" },
        { candidate: "Participation", score: "" },
        { candidate: "Vote blanc", party: "Non comptabilisé", score: "" },
        { candidate: "Vote Nul", party: "Non comptabilisé", score: "" },
      ],
