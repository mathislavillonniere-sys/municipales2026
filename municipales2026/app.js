...
const citiesData = [
  ...
  },
  {
    ...
    results2026: {
      tour1: [
        { candidate: "Grégory Doucet", party: "EELV", score: "37,36%" },
        {
  ...
  },
  {
    ...
    candidates: [
      ...
      },
      {
        ...
        color: "#bb0000",
        score: "",
        slogan: "Pour l'unité ouvrière, contre la guerre",
      },
    ],
    polls: [],
    results2020: {
    ...
    results2026: {
      tour1: [
        ...
        { candidate: "Ludovic Mendes", party: "RE - DVC", score: "" },
        { candidate: "Charlotte Leduc", party: "LFI - NPA-A", score: "" },
        { candidate: "Gaël Diafera", party: "NPA-R", score: "" },
        { candidate: "Mario Rinaldi", party: "LO", score: "" },
        { candidate: "Marie-Jeanne Becht", party: "PT", score: "" },
        { candidate: "Participation", score: "" },
        { candidate: "Vote blanc", party: "Non comptabilisé", score: "" },
        { candidate: "Vote Nul", party: "Non comptabilisé", score: "" },
      ],
  ...
  },
  {
    ...
    candidates: [
      ...
      {
        name: "Phillipe Saurel",
        party: "DVG - Utiles",
        color: "#ffc0c0",
        score: "",
        slogan: "Montpellier Citoyenne",
      },
      {
        name: "Rémi Gaillard",
        party: "SE",
    ...
    results2026: {
      tour1: [
        ...
        { candidate: "Phillipe Saurel", party: "DVG - Utiles", score: "" },
        { candidate: "Rémi Gaillard", party: "SE", score: "" },
        { candidate: "Max Muller", party: "RP", score: "" },
        { candidate: "Participation", score: "" },
        { candidate: "Vote blanc", party: "Non comptabilisé", score: "" },
        { candidate: "Vote Nul", party: "Non comptabilisé", score: "" },
      ],
  ...
  },
  {
    ...
    results2026: {
      tour1: [
        ...
        { candidate: "Émeline Nohan", party: "LR - HOR - UDI", score: "" },
        { candidate: "Nora Deliba", party: "SE", score: "" },
        { candidate: "Choukri Yonis", party: "DVG", score: "" },
        { candidate: "Serge Mercier", party: "LO", score: "" },
        { candidate: "Christel Keiser", party: "PT", score: "" },
        { candidate: "Participation", score: "" },
        { candidate: "Vote blanc", party: "Non comptabilisé", score: "" },
        { candidate: "Vote Nul", party: "Non comptabilisé", score: "" },
      ],
  ...
  // --- N ---
  {
    ...
    results2026: {
      tour1: [
        ...
        { candidate: "Christiane Nimsgern", party: "LO", score: "" },
        { candidate: "Participation", score: "" },
        { candidate: "Vote blanc", party: "Non comptabilisé", score: "" },
        { candidate: "Vote Nul", party: "Non comptabilisé", score: "" },
      ],
  ...
  },
  {
    ...
    candidates: [
      ...
      {
        name: "Alexandre Gauvin",
        party: "NPA-R",
        color: "#bb0000",
        score: "",
        slogan: "NPA - Révolutionnaires ! Nantes ouvrière et révolutionnaire",
      },
    ],
    polls: [
      {
    ...
    results2026: {
      tour1: [
        ...
        { candidate: "Mounir Belhamiti", party: "RE diss. - LC", score: "" },
        { candidate: "William Aucant", party: "LFI", score: "" },
        { candidate: "Jean-Claude Hulot", party: "RN / UDR", score: "" },
        { candidate: "Margot Medkour", party: "DVG", score: "" },
        { candidate: "Nicolas Bazille", party: "LO", score: "" },
        { candidate: "Alexandre Gauvin", party: "NPA-R", score: "" },
        { candidate: "Participation", score: "" },
        { candidate: "Vote blanc", party: "Non comptabilisé", score: "" },
        { candidate: "Vote Nul", party: "Non comptabilisé", score: "" },
      ],
  ...
  },
  {
    ...
    candidates: [
      ...
      },
      {
        ...
        color: "#13151d",
        score: "",
        slogan: "À La Reconquête de Nice",
      },
      {
        name: "Estelle Jacquet",
        party: "LO",
        color: "#bb0000",
        score: "",
        slogan: "Lutte ouvrière - Le camp des travailleurs",
      ...
      {
        name: "Céline Forjonnel",
        party: "SE",
        color: "#cccccc",
        score: "",
        slogan: "Nice démocratie directe",
      },
    ],
    polls: [
      {
    ...
    results2026: {
      tour1: [
        ...
        { candidate: "Mireille Damiano", party: "LFI", score: "" },
        { candidate: "Cédric Vella", party: "REC", score: "" },
        { candidate: "Estelle Jacquet", party: "LO", score: "" },
        { candidate: "Céline Forjonnel", party: "SE", score: "" },
        { candidate: "Participation", score: "" },
        { candidate: "Vote blanc", party: "Non comptabilisé", score: "" },
        { candidate: "Vote Nul", party: "Non comptabilisé", score: "" },
      ],
  ...
  // --- O ---
  {
    ...
    candidates: [
      ...
      },
      {
        ...
        color: "#00C000",
        score: "",
        slogan: "Orléans solidaire et écologique",
      },
      {
      ...
      },
      {
        ...
        color: "#ffd76e",
        score: "",
        slogan: "Notre ville plus que jamais vivante",
      },
      {
        name: "Farida Megdoud",
        party: "LO",
      ...
      },
      {
        ...
        color: "#13151d",
        score: "",
        slogan: "À la Reconquête ! d'Orléans",
      },
    ],
    polls: [],
    results2026: {
      tour1: [
        ...
        { candidate: "Caroline Janvier", party: "RE Diss.", score: "" },
        {
        ...
        { candidate: "Tiffanie Rabault", party: "RN", score: "" },
        { candidate: "Valentin Pelé", party: "LFI", score: "" },
        { candidate: "Grégory Meyer", party: "HOR Diss.", score: "" },
        { candidate: "Farida Megdoud", party: "LO", score: "" },
        { candidate: "Isabelle Lamarque", party: "REC", score: "" },
        { candidate: "Participation", score: "" },
        { candidate: "Vote blanc", party: "Non comptabilisé", score: "" },
        { candidate: "Vote Nul", party: "Non comptabilisé", score: "" },
      ],
  ...
  },
  {
    ...
    candidates: [
      ...
      },
      {
        ...
        color: "#FF3333",
        score: "",
        slogan: "Poitiers ambitieuse et solidaire",
      },
      {
        name: "Bertrand Geay",
        party: "LFI/PCF/NPA",
      ...
      },
      {
        ...
        color: "#052656",
        score: "",
        slogan: "Liberté pour Poitiers",
      },
      {
        name: "Ludovic Gaillard",
        party: "LO",
        color: "#bb0000",
        score: "",
    ...
    results2026: {
      tour1: [
        ...
        { candidate: "Ludovic Gaillard", party: "LO²", score: "" },
        { candidate: "Participation", score: "" },
        { candidate: "Vote blanc", party: "Non comptabilisé", score: "" },
        { candidate: "Vote Nul", party: "Non comptabilisé", score: "" },
      ],
