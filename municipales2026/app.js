...
const citiesData = [
  ...
  },
  {
    ...
    results2026: {
      ...
      tour2: [
        {
          candidate: "Arnaud Deslandes",
          party: "PS / PCF / G.s - Les Écologistes / G.s / L'A / Gé",
          score: "26,26%",
        },
        {
          candidate: "Lahouaria Addouche",
  ...
  },
  {
    ...
    results2026: {
      ...
      tour2: [
        {
          candidate: "Grégory Doucet",
          party: "LÉ - PS - PP - PCF - VC - L'A - D! - G.s - GRS / LFI",
          score: "",
        },
        {
          candidate: "Jean-Michel Aulas",
  ...
  },
  {
    ...
    results2026: {
      ...
      tour2: [
        ...
        { candidate: "Étienne Anstett", party: "RN - UDR", score: "" },
        {
          candidate: "Bertrand Mertz",
          party: "PS - PP - LRDG - LC",
          score: "",
        },
        { candidate: "Charlotte Leduc", party: "LFI - NPA-A / LÉ", score: "" },
        { candidate: "Participation", score: "" },
        { candidate: "Vote blanc", party: "Non comptabilisé", score: "" },
        { candidate: "Vote Nul", party: "Non comptabilisé", score: "" },
      ],
  ...
  },
  {
    ...
    results2026: {
      ...
      tour2: [
        ...
        { candidate: "Mohed Altrad", party: "DVC - HOR - RE diss.", score: "" },
        { candidate: "Participation", score: "" },
        { candidate: "Vote blanc", party: "Non comptabilisé", score: "" },
        { candidate: "Vote Nul", party: "Non comptabilisé", score: "" },
      ],
  ...
  },
  {
    ...
    results2026: {
      ...
      tour2: [
        ...
        { candidate: "Frédéric Marquet", party: "SE / DVC - RE", score: "" },
    ...
    results2026: {
      ...
      tour2: [
        ...
        },
        {
          candidate: "Baptiste Chapuis",
          party:
            "PS - PCF - G.s - PP - GRS - D! - L'A - PRG - ND - OE / OSE - LÉ - ÉCO - VO!",
          score: "",
        },
        { candidate: "Participation", score: "" },
        { candidate: "Vote blanc", party: "Non comptabilisé", score: "" },
  ...
  },
  {
    ...
    results2026: {
      ...
      tour2: [
        {
          candidate: "Léonore Moncond'huy",
          party: "LÉ - G.s - GÉ - GRS - ND / LFI - PCF",
          score: "",
        },
        {
          candidate: "Anthony Brottier",
  ...
  },
  {
    ...
    results2026: {
      ...
      tour2: [
        ...
        { candidate: "Corentin Jousserand", party: "RN", score: "" },
        {
          candidate: "Dino Cinieri",
          party: "LR - MoDem - PRV - PRG - RE - UDI",
          score: "",
        },
        { candidate: "Valentine Mercier", party: "LFI", score: "" },
        { candidate: "Participation", score: "" },
        { candidate: "Vote blanc", party: "Non comptabilisé", score: "" },
        { candidate: "Vote Nul", party: "Non comptabilisé", score: "" },
      ],
  ...
  // --- T ---
  {
    ...
    results2026: {
      ...
      tour2: [
        { candidate: "Laure Lavalette", party: "RN / UDR", score: "" },
        { candidate: "Josée Massi", party: "DVD", score: "" },
        { candidate: "Participation", score: "" },
        { candidate: "Vote blanc", party: "Non comptabilisé", score: "" },
        { candidate: "Vote Nul", party: "Non comptabilisé", score: "" },
      ],
  ...
  },
  {
    ...
    results2026: {
      ...
      tour2: [
        {
          candidate: "Emmanuel Denis",
          party: "Les Écologistes - PS - PCF / LFI",
          score: "",
        },
        {
          candidate: "Christophe Bouchet",
  ...
  },
  {
    ...
    results2026: {
      ...
      tour2: [
        {
          candidate: "Bernard Combes",
          party: "DVG-PS / PCF-LFI-LÉ",
          score: "",
        },
